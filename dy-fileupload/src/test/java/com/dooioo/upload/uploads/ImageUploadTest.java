...
public class ImageUploadTest {
    ...
    public void testUpload() throws UploadException {
        System.out.println(ImageUpload.upload(data, "dooioo.jpg", Company.DOOIOO, new ImageArgConvert(ImageSize.IMAGE_SIZE_500x375, Logo.Logo), new ImageArgConvert(ImageSize.IMAGE_SIZE_100x75, Logo.Logo)));
    }
